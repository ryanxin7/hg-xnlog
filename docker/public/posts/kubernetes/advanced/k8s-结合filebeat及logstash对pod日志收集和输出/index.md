...
```bash
root@zk1:/apps/kafka# cat config/server.properties | grep -v "^#"  |grep -v "^$"
broker.id=26
listeners=PLAINTEXT://192.168.149.26:9092
...
zookeeper.connect=192.167.149.26:2181,192.168.149.27:2181,192.168.149.28:2181
...
### 6.1 配置对接ES集群
 ...
 ```bash
 root@kibana:/tmp# dpkg -i kibana-7.6.2-amd64.deb
...
server.host: "192.168.149.29"
elasticsearch.hosts: ["http://192.168.149.22:9200","http://192.168.149.23:9200","http://192.168.149.24:9200"]
```
